...
class OdometryNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('wheel_base_x', 0.3)   # 30cm entre ruedas frontales/traseras
        self.declare_parameter('wheel_base_y', 0.28)   # 40cm entre ruedas izquierda/derecha
        self.declare_parameter('encoder_ppr', 1000)
        
        # Inicializar hardware
        self.encoders = [
            OpticalEncoder(pin_a=4, pin_b=6, ppr=1000, node=self),
            OpticalEncoder(pin_a=9, pin_b=10, ppr=1000, node=self),
            OpticalEncoder(pin_a=13, pin_b=15, ppr=1000, node=self),
            OpticalEncoder(pin_a=16, pin_b=18, ppr=1000, node=self)
        ]
